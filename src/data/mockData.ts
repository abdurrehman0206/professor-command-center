...
import { User, Course, Student, Assignment, Submission, Notification, AnalyticsData } from '@/types';
...
export const mockStudents: Student[] = [
  { id: '1', name: 'Alice Johnson', email: 'alice.j@student.edu', courseId: '1' },
  { id: '2', name: 'Bob Smith', email: 'bob.s@student.edu', courseId: '1' },
  { id: '3', name: 'Carol Davis', email: 'carol.d@student.edu', courseId: '1' },
  { id: '4', name: 'David Wilson', email: 'david.w@student.edu', courseId: '1' },
  { id: '5', name: 'Emma Brown', email: 'emma.b@student.edu', courseId: '2' },
  { id: '6', name: 'Frank Miller', email: 'frank.m@student.edu', courseId: '2' },
  { id: '7', name: 'Grace Taylor', email: 'grace.t@student.edu', courseId: '3' },
  { id: '8', name: 'Henry Anderson', email: 'henry.a@student.edu', courseId: '3' }
];
